...
<body class="body-admin bg-celeste">
    ...
    <div class="m-3 ms-1 p-4 bg-white rounded-5">
        <h1 class="text-center txt-azul-oscuro mt-5">Eventos</h1>
        
        <div class="ms-4 my-5">
            <a href="index.php?c=admin&a=agregarEvento" class="my-5 py-2 px-4 bg-celeste rounded-pill text-decoration-none">Agregar</a>
        </div>
        <div class="ms-4">
            <table class="table">
                <thead>
                ...
                <tbody>
                    <?php foreach ($eventos as $e): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="index.php?c=admin&a=eliminarEvento" method="POST" style="display:inline;" class="form-eliminar">
