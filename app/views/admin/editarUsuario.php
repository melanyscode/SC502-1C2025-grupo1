            ...
            <form action="index.php?c=admin&a=guardarEditUsuario" method="POST" class="mt-5" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="col mb-3">
                            <label>Correo</label>
                            <input type="text" name="correoEdit" value="<?php echo $usuario['direccion']?>" class="input-adopcion bg-celeste">
                        </div>
                        <div class="col mb-3">
                            <label>Direccion</label>
                            <input type="text" name="direccionEdit" value="<?php echo $usuario['correo']?>" class="input-adopcion bg-celeste">
                        </div>
                        <div class="row">
                            <div class="col mb-3">
