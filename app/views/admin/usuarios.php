                ...
                <tbody>
                    <?php foreach ($usuarios as $u): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="index.php?c=admin&a=eliminarUsuario" method="POST" style="display:inline;">
                                    <input type="hidden" name="id" value="<?= $u['id_usuario'] ?>">
                                    <button type="submit" onclick="return confirm('¿Estás seguro de eliminar este usuario?')" style="border: none; background: none; padding: 0;">
